...
CREATE TABLE IF NOT EXISTS appbricks_user(
    id varcahr(32)  primary key,    username varchar(255)  ,    usernumber varchar(255)  ,    password varchar(255)  ,    token varchar(255)  ,    fullname varchar(255)  ,    fullname_en varchar(255)  ,    email varchar(255)  ,    gender varchar(255)  ,    tel varchar(255)  ,    update_time datetime  ,    update_person varchar(255)  ,    create_time datetime  ,    create_person varchar(255)  ,    guid varchar(255)  ,    current_project_no varchar(255)  ,    project_no varchar(255)  ,    status varchar(255)  ,    type varchar(255)  ,    avatar varchar(255)  );
CREATE TABLE IF NOT EXISTS appbricks_department(
    id varcahr(32)  primary key,    name varchar(255)  ,    name_en varchar(255)  ,    code varchar(255)  ,    parent_id varchar(255)  ,    update_time datetime  ,    create_time datetime  ,    project_no varchar(255)  );
