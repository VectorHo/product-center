...
sudo mv $proj_home/deepexi-product-center-provider/target/deepexi-product-center-*.jar $proj_home/deepexi-product-center-provider/target/demo.jar # 兼容所有sh脚本
